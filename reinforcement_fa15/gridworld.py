...
def getLongGrid():
    ...
    for g in grid:
        print g
    raw_input("This is what the LongGrid looks like. Press Enter to continue...")
    return Gridworld(grid)
...
def getBigMazeGrid():
    ...
    for g in grid:
        print g
    raw_input("This is what the BigMazeGrid looks like. Press Enter to continue...")
    return Gridworld(grid)
...
def parseOptions():
    ...
    optParser.add_option('-g', '--grid',action='store',
                         ...
                         help='Grid to use (case sensitive; options are BookGrid, BridgeGrid, CliffGrid, MazeGrid, DiscountGrid, default %default)' )
    optParser.add_option('-w', '--windowSize', metavar="X", type='int',dest='gridSize',default=150,
                         help='Request a window width of X pixels *per grid cell* (default %default)')
    optParser.add_option('-a', '--agent',action='store', metavar="A",
                         type='string',dest='agent',default="random",
                         help='Agent type (options are \'random\', \'asynchvalue\', \'priosweepvalue\', \'policy\', and \'q\', default %default)')
    ...
    optParser.add_option('-y', '--noDisplay',action='store_true' ,default=False,
                         help='Turn off display')
...
if __name__ == '__main__':
    ...
    import valueIterationAgents, policyIterationAgents, qlearningAgents
    a = None
    if opts.agent == 'value':
        print "ERROR: no agent option of 'value'"
        sys.exit(0)
